...
public class Main {
	...
	public static void main(String[] args) {
		...
		Address ad2 = new Address("Beam", "Jim", "Whiskey Lane 30", 8888,
				"Lol City", Address.Country.GERMANY);

		Address ad3 = new Address("Shurl", "Trol", "Smokey Alley 99", 7777,
				"Banana City", Address.Country.AUSTRIA);

		Address ad4 = new Address("Plokt", "Timmy", "Lobster Gate 7", 6655,
				"Omnomnom County", Address.Country.SWITZERLAND);
