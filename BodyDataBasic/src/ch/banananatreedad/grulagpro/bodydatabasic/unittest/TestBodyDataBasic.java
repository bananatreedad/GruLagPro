...
public class TestBodyDataBasic {
	...
	public void testBSA() {
		...
		System.out.println("BSA of an adult with size 182cm and weight 71kg: "
				+ bsaAdult + "m2");
		assertTrue(bsaAdult == 1.91);

		BodyDataBasic testKid = new BodyDataBasic(130, 35);
		double bsaKid = testKid.getBSAchildren();
		System.out.println("BSA of an kid with size 130cm and weight 39kg: "
				+ bsaKid + "m2");
		...
		System.out
				.println("BSA of a young adult with size 170cm and weight 60kg: "
						+ bsaYoungAdult + "m2");
